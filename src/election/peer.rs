...
pub struct Peer {
    ...
    pub next_index: u64,  // The initial value is the index of the leader's last log entry + 1
    pub match_index: u64, // The initial value is 0
...
impl PeerManager {
    ...
    // Find the majority match_index from match_index
    pub fn quorum_match_index(
        ...
        // new server new_quorum_match_index
