...
pub async fn start_server(
    ...
    info!("Election server listening on {}", addr);
...
impl proto::consensus_rpc_server::ConsensusRpc for Server {
    async fn append_entries(
        &self,
        request: tonic::Request<proto::AppendEntriesReq>,
    ) -> Result<tonic::Response<proto::AppendEntriesResp>, tonic::Status> {
    ...
    async fn request_vote(
        &self,
        request: tonic::Request<proto::RequestVoteReq>,
    ) -> Result<tonic::Response<proto::RequestVoteResp>, tonic::Status> {
        let addr = request.remote_addr().unwrap();
        info!(
    ...
    async fn install_snapshot(
        &self,
        request: tonic::Request<proto::InstallSnapshotReq>,
    ) -> Result<tonic::Response<proto::InstallSnapshotResp>, tonic::Status> {
        let addr = request.remote_addr().unwrap();
        info!(
...
impl proto::management_rpc_server::ManagementRpc for Server {
    async fn get_leader(
        &self,
        request: tonic::Request<proto::GetLeaderReq>,
    ) -> Result<tonic::Response<proto::GetLeaderResp>, tonic::Status> {
        let addr = request.remote_addr().unwrap();
        info!(
    ...
    async fn get_configuration(
        &self,
        request: tonic::Request<proto::GetConfigurationReq>,
    ) -> Result<tonic::Response<proto::GetConfigurationResp>, tonic::Status> {
        let addr = request.remote_addr().unwrap();
        info!(
    ...
    async fn set_configuration(
        &self,
        request: tonic::Request<proto::SetConfigurationReq>,
    ) -> Result<tonic::Response<proto::SetConfigurationResp>, tonic::Status> {
        let consensus = self.consensus.clone();
        // Avoid failures when starting another tokio runtime inside a tokio runtime
...
impl Client {
    pub async fn append_entries(
        &mut self,
        req: proto::AppendEntriesReq,
        addr: String,
    ) -> Result<proto::AppendEntriesResp, Box<dyn std::error::Error>> {
    ...
    pub async fn request_vote(
        &mut self,
        req: proto::RequestVoteReq,
        addr: String,
    ) -> Result<proto::RequestVoteResp, Box<dyn std::error::Error>> {
        let addr_clone = addr.clone();
    ...
    pub async fn install_snapshot(
        &mut self,
        req: proto::InstallSnapshotReq,
        addr: String,
    ) -> Result<proto::InstallSnapshotResp, Box<dyn std::error::Error>> {
        let addr_clone = addr.clone();
